...
{logo && <img alt="logo" src={logo} className="w-12 h-12 rounded-md object-contain" />}
<div>
<h3 className="text-lg font-semibold">{title} <span className="opacity-70">— {company}</span></h3>
...
return (
<section id="experiences" className="snap-section relative min-h-screen overflow-hidden bg-white text-slate-900 dark:bg-[#0f1420] dark:text-gray-100">
<DenseShapes seed={31} count={90} />
<div className="relative z-10 max-w-5xl mx-auto px-6 md:px-8 py-20 space-y-6">
<Reveal><h2 className="text-4xl font-bold mb-4">Experiences</h2></Reveal>
